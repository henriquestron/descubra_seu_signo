...
// Verifica se a chave 'data_nascimento' foi enviada e não está vazia
if (!isset($_POST['data_nascimento']) || empty($_POST['data_nascimento'])) {
    echo "<p>Data de nascimento não fornecida ou é inválida.</p> <a href='index.php'>Voltar</a>";
    exit;
}

// Inicializa a variável $data_nascimento
...
function verificar_signo($data, $inicio, $fim){
    ...
    // Ajusta o ano caso a data de início ou fim atravesse o ano
